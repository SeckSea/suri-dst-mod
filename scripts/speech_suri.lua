...
return {
	ACTIONFAIL =
	{
        APPRAISE =
        {
            NOTNOW = "Erm, I’ll come back later",
        },
        REPAIR =
        {
            WRONGPIECE = "oops, mah fault",
        },
        BUILD =
        {
            MOUNTED = "hmm, better get down first",
            HASPET = "I already got a pet",
			TICOON = "but i already got one",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "i ain't going near that thing while it’s awake!!",
			GENERIC = "can't shave that ting",
			NOBITS = "theres nothin left",
            REFUSE = "only_used_by_woodie",
            SOMEONEELSESBEEFALO = "naw that boy aint mine",
		},
		STORE =
		{
			GENERIC = "is full",
        ...
        CONSTRUCT =
        {
            ...
            EMPTY = "i need somepthin to build wit",
            MISMATCH = "oops, wrong plans",
            NOTREADY = "naur, not ready yet",
        },
		RUMMAGE =
		{
			GENERIC = "i can't do that",
			INUSE = "getting down and dirty in there",
            NOTMASTERCHEF = "i'm not a fancy enough chef for that",
            NOTAMERM = "erm, the merms probably wouldnt be happy about that",
		},
		UNLOCK =
        {
            WRONGKEY = "can't do that",
        },
		USEKLAUSSACKKEY =
        {
            WRONGKEY = "wrong thang",
            KLAUS = "occupado here!",
			QUAGMIRE_WRONGKEY = "gotta find another key",
        },
		ACTIVATE =
		{
			LOCKED_GATE = "gate is locked",
            HOSTBUSY = "what’re they up to…",
            CARNIVAL_HOST_HERE = "theyre here somewhere…",
            NOCARNIVAL = "looks like they left",
			EMPTY_CATCOONDEN = "GRAH! no treasure?!?!",
			KITCOON_HIDEANDSEEK_NOT_ENOUGH_HIDERS = "need more for a balanced game…",
			KITCOON_HIDEANDSEEK_NOT_ENOUGH_HIDING_SPOTS = "not many hiding spots….",
			KITCOON_HIDEANDSEEK_ONE_GAME_PER_DAY = "okie, enough for today",
            MANNEQUIN_EQUIPSWAPFAILED = "perhaps not their style",
            PILLOWFIGHT_NO_HANDPILLOW = "wah! im unarmed",
            NOTMYBERNIE = "squishy not so scary!",
            NOTMERM = "takes a merm to call a merm",
        ...
        COOK =
        {
            GENERIC = "can't cook right now ;-;",
            INUSE = "we got the same idea",
            TOOFAR = "too far!",
        },
        START_CARRAT_RACE =
        {
            NO_RACERS = "what am i missin here",
        },

		DISMANTLE = 
		{
			COOKING = "Let them cook!",
			INUSE = "have to wait my turn",
			NOTEMPTY = "have to make it shiny first!",
        },
        FISH_OCEAN =
		{
			TOODEEP = "this rod aint for deep sea fih",
		},
        OCEAN_FISHING_POND =
		{
			WRONGGEAR = "this rods not for pond fih",
		},
        ...
        GIVE =
        {
            GENERIC = "that dont go there",
            DEAD = "maybe ill hold on to dis.",
            SLEEPING = "Too eepy to care",
            BUSY = "guess ill try again later",
            ABIGAILHEART = "was worth a shot",
            GHOSTHEART = "perhaps this is a bad idea",
            NOTGEM = "im not sticking that in there!",
            WRONGGEM = "this gem aint it",
			NOGENERATORSKILL = "cant put that there",
            NOTSTAFF = "not really the right shape",
            MUSHROOMFARM_NEEDSSHROOM = "a mushroom would might be more useful",
            MUSHROOMFARM_NEEDSLOG = "maybe a living log could work",
            MUSHROOMFARM_NOMOONALLOWED = "these mushrooms dont wanna be planted!!",
            SLOTFULL = "already got somethin there",
            FOODFULL = "there's already food there!",
            NOTDISH = "it won't want to eat that",
            DUPLICATE = "...we already know that one",
            NOTSCULPTABLE = "i cant make dat into a sculpture",
            NOTATRIUMKEY = "err, not quite the right shape",
            CANTSHADOWREVIVE = "it won't come back to lief",
            WRONGSHADOWFORM = "is this put together right..?",
            NOMOON = "i needa see the moon for this",
			PIGKINGGAME_MESSY = "mann, need to clean up first",
			PIGKINGGAME_DANGER = "danger nearby for that!",
			PIGKINGGAME_TOOLATE = "too late",
			CARNIVALGAME_INVALID_ITEM = "need to buy me some tokens",
			CARNIVALGAME_ALREADY_PLAYING = "theres already a game going!",
            SPIDERNOHAT = "i can't fit them in my pocket",
            TERRARIUM_REFUSE = "maybe i should try different kinds of fuel...",
            TERRARIUM_COOLDOWN = "the tree has to grow back before we can give it anything",
            NOTAMONKEY = "huh, i don't speak monkey",
            QUEENBUSY = "she seems busy",
        },
        GIVETOPLAYER =
        {
            FULL = "your pockets are too full!!",
            DEAD = "maybe ill hold on to this…",
            SLEEPING = "too eepy to care",
            BUSY = "i'll try again in sec",
        },
        GIVEALLTOPLAYER =
        {
            FULL = "your pockets are too full!!!",
        ...
        WRITE =
        {
            GENERIC = "methinks it's fine as is",
        ...
        CHANGEIN =
        {
            GENERIC = "i don't wanna change rn",
            BURNING = "it's a lil dangerous right now…",
            INUSE = "one style change at a time i guess",
            NOTENOUGHHAIR = "theres not enough fur to style",
            NOOCCUPANT = "maybe needs something hitched up",
        },
        ATTUNE =
        {
            NOHEALTH = "i don feel so good",
        },
        MOUNT =
        {
        ...
        SADDLE =
        {
            TARGETINCOMBAT = "not while it's angy",
        },
        TEACH =
        {
            --Recipes/Teacher
            KNOWN = "i already studied this!",
            CANTLEARN = "uuu, i can't learn that one",

            --MapRecorder/MapExplorer
            WRONGWORLD = "this maps for somewhere else",
            ...
            STASH_MAP_NOT_FOUND = "i don't see an \"X marks the spot\"!!",-- Likely trying to read stash map  in world without stash                  
        },
        WRAPBUNDLE =
        {
            EMPTY = "I need something to wrap fisrt",
        },
        PICKUP =
        {
			RESTRICTION = "im not skill enough for that",
        ...
        SAIL =
        {
            REPAIR = "doesn't look like need repairing",
        },
        ROW_FAIL =
        {
        ...
        BATHBOMB =
        {
            ...
            ALREADY_BOMBED = "theres already a bath bomb here",
        },
		GIVE_TACKLESKETCH =
		{
		...
		COMPARE_WEIGHABLE =
		{
            FISH_TOO_SMALL = "this one's a small fry",
            OVERSIZEDVEGGIES_TOO_SMALL = "hmm, not quite heavy enough",
		},
        BEGIN_QUEST =
        {
        ...
        {
            GENERIC = "there’s nothin left to learn",
            FERTILIZER = "i dont wanna know anything further",
        },
        FILL_OCEAN =
        {
            UNSUITABLE_FOR_PLANTS = "duh,plants don't like salt water",
        },
        POUR_WATER =
        {
            OUT_OF_WATER = "naur, no more water",
        },
        POUR_WATER_GROUNDTILE =
        {
            OUT_OF_WATER = "my watering can is out",
        },
        USEITEMON =
        {
            ...
            BEEF_BELL_INVALID_TARGET = "i cant!",
            BEEF_BELL_ALREADY_USED = "this guy belongs to someone else",
            BEEF_BELL_HAS_BEEF_ALREADY = "i got enough!!",
        },
        HITCHUP =
        {
            NEEDBEEF = "if I had a bell I could make friends with a beefalo!",
            NEEDBEEF_CLOSER = "my beef buddy is too far",
            BEEF_HITCHED = "my beefalo is already hitched up",
            INMOOD = "mah beefalo seems to be too lively",
        },
        MARK =
        {
            ALREADY_MARKED = "i already made my pick",
            NOT_PARTICIPANT = "i've got no steak in this contest",
        },
        YOTB_STARTCONTEST =
        {
            DOESNTWORK = "i guess they don't support the arts here ;-;",
            ALREADYACTIVE = "must be busy with another contest somewhere",
        },
        YOTB_UNLOCKSKIN =
        {
            ALREADYKNOWN = "im seein a familiar pattern... ive learned this already!",
        },
        CARNIVALGAME_FEED =
        {
            TOO_LATE = "i have to be quicker!",
        },
        HERD_FOLLOWERS =
        {
        ...
        HARVEST =
        {
            DOER_ISNT_MODULE_OWNER = "it doesn't seem interested in a civilized discussion",
        },
	...
	{
		NO_INGREDIENTS = "im missing some parts",
		NO_TECH = "This needs more research!",
		NO_STATION = "i can't craft it yet",
	},

	ACTIONFAIL_GENERIC = "i can't do that",
	ANNOUNCE_BOAT_LEAK = "eek! leak!",
	ANNOUNCE_BOAT_SINK = "im a sun dragon not a water dragon!!!",
	...
	ANNOUNCE_ADVENTUREFAIL = "uuuu, i have to try again",
    ANNOUNCE_MOUNT_LOWHEALTH = "it looks hurt",
	...
	ANNOUNCE_BOOMERANG = "owie! i shouldve caught that",
	ANNOUNCE_CHARLIE = "huh, hello? Is someone there?",
	ANNOUNCE_CHARLIE_ATTACK = "hey! something bit me!",
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific
	ANNOUNCE_COLD = "too cold!",
	ANNOUNCE_HOT = "im not supposed to be in heat!",
	ANNOUNCE_CRAFTING_FAIL = "im missing some ingredients",
	ANNOUNCE_DEERCLOPS = "so big!",
	ANNOUNCE_CAVEIN = "the cave is crumbling!",
	ANNOUNCE_ANTLION_SINKHOLE =
	{
		"wheres the ground going?!?!",
		"shakey!",
		"so wobbly!",
	},
	ANNOUNCE_ANTLION_TRIBUTE =
	{
        "usually i receive the tributes",
        "...fine, tribute for the Antlion",
        "this should please it, for now...",
	},
	ANNOUNCE_SACREDCHEST_YES = "oh, i guess I'm worthy",
	ANNOUNCE_SACREDCHEST_NO = "wuh oh, it didn't like that",
    ANNOUNCE_DUSK = "finally, rat hours are coming",
	...
	ANNOUNCE_EAT =
	{
		...
		SPOILED = "ew what is this!",
		STALE = "i think that was spoiling",
		INVALID = "i cant eat that!",
        YUCKY = "yucky!",
    ...
    {
        "huff... pant...",
        "goobahs…should be carrying this…",
        "lift... with your back...",
        "this isn't... an emperor’s job...",
        "must…keep going",
    ...
    ANNOUNCE_RUINS_RESET = "the monsters are back!",
    ANNOUNCE_SNARED = "sharp! sharp bones!!",
    ANNOUNCE_SNARED_IVY = "help! the garden is fighting back!",
    ANNOUNCE_REPELLED = "it has a shield!",
	ANNOUNCE_ENTER_DARK = "so dark!",
	ANNOUNCE_ENTER_LIGHT = "the light! i can see again!",
	ANNOUNCE_FREEDOM = "i'm free! i'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "im a smart dragon now!",
	ANNOUNCE_HOUNDS = "whats that noise?!",
	ANNOUNCE_WORMS = "...did you feel that?",
    ANNOUNCE_ACIDBATS = "did you hear that?!",
	ANNOUNCE_HUNGRY = "...so hungy",
	ANNOUNCE_HUNT_BEAST_NEARBY = "fresh tracks, da beast is probably close",
	ANNOUNCE_HUNT_LOST_TRAIL = "the beast trail ends here",
	...
	DESCRIBE =
	{
        ...
        WORMWOOD_MUTANTPROXY_LIGHTFLIER = "Weird, carrying one makes my pocket feel lighter!",
        ...
        EMBERLIGHT = "A fire without fuel? Eh.",
        ...
        BOATRACE_CHECKPOINT = "Checkpoint!",
    ...
    DESCRIBE_PLANTSTRESSORKILLJOYS = "Goobahs might have to do a bit of weeding...",
    DESCRIBE_PLANTSTRESSORFAMILY = "It's my scientific conclusion that this plant seems lonely.",
    DESCRIBE_PLANTSTRESSOROVERCROWDING = "Too many plants competing here",
