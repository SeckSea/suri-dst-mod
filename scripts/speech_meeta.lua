...
return {
	ACTIONFAIL =
	{
        ...
        REPAIR =
        {
            WRONGPIECE = "Hmm was that wrong? Wakanai.",
        },
        BUILD =
        {
            MOUNTED = "Ain’t no way I can reach from here.",
            HASPET = "I already got a servant.",
			TICOON = "Nah dawg, I can’t be following another Ticoon.",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "Nuh uh, not while he’s awake.",
			GENERIC = "Nuh uh, can’t shave that.",
			NOBITS = "Bruh, there’s nothing to shave there.",
            REFUSE = "only_used_by_woodie",
            SOMEONEELSESBEEFALO = "Ain’t no way, shave your own beefalo!",
		},
		STORE =
		{
			GENERIC = "This thing is full.",
			NOTALLOWED = "Can’t put this there, dawg.",
			INUSE = "Should probably wait my turn.",
            NOTMASTERCHEF = "Dawg, who am I? Gordon Ramsay?",
		},
        CONSTRUCT =
        {
            INUSE = "Fudge, someone else set up shop here.",
            NOTALLOWED = "I can’t t-spin this.",
            EMPTY = "It’s not going to build itself, dummy.",
            MISMATCH = "Whoopsie! Wrong plans.",
            NOTREADY = "It’s not ready yet? Fudge!",
        },
		RUMMAGE =
		{
			GENERIC = "No puedo!",
			INUSE = "Let me know if you find anything cool.",
            NOTMASTERCHEF = "I may be the master chef or whateva, but not even I can do that.",
            NOTAMERM = "mermmerm",
		},
		UNLOCK =
        {
		...
		USEKLAUSSACKKEY =
        {
            WRONGKEY = "Whoopsie! That wasn't right.",
            KLAUS = "Chotto matte!",
			QUAGMIRE_WRONGKEY = "Fudge, this is why I hate keys.",
        },
		ACTIVATE =
		{
			LOCKED_GATE = "Fudge, the gate is locked.",
            ...
            MANNEQUIN_EQUIPSWAPFAILED = "It’s not swag enough for my drip, whateva.",
            PILLOWFIGHT_NO_HANDPILLOW = "I need a body pillow to fight with.",
            NOTMYBERNIE = "This isn’t my Rito.",
            NOTMERM = "Isn’t this a job for Mermaid Man?",
            NOKELP = "only_used_by_wurt",
            HASMERMLEADER = "only_used_by_wurt",
		},
		OPEN_CRAFTING =
		{
            PROFESSIONALCHEF = "I may be the master chef or whateva, but not even I can do that.",
			SHADOWMAGIC = "Easy stuff for a witch like me.",
		},
        COOK =
        {
            GENERIC = "I can't cook this, am I missing an ingredient?",
            INUSE = "Dawg, hurry up!",
            TOOFAR = "Bruh, that’s too far from me!",
        },
        START_CARRAT_RACE =
        {
		...
		DISMANTLE = 
		{
			COOKING = "Let’s not waste food.",
			INUSE = "Hurry hurry, I wanna cook!",
			NOTEMPTY = "I gotta clean it first.",
        },
        FISH_OCEAN =
		{
			TOODEEP = "Fudge, too deep for this rod.",
		},
        OCEAN_FISHING_POND =
		{
			WRONGGEAR = "Fudge, to shallow for this rod.",
		},
        ...
        GIVE =
        {
            GENERIC = "Shoot, it doesn’t go there.",
            DEAD = "Hehe, mine now.",
            SLEEPING = "WAKE UP WAKE UP!",
            BUSY = "Chotto matte.",
            ABIGAILHEART = "It was worth a shot.",
            GHOSTHEART = "Perhaps this is a bad idea.",
            NOTGEM = "It doesn’t go there!",
            WRONGGEM = "That’s the wrong gem!",
			NOGENERATORSKILL = "No way it goes in there.",
            NOTSTAFF = "I’m not good at shapes.",
            ...
            NOTDISH = "I’m not eating that!",
            DUPLICATE = "Erm actually, I already know that one.",
            NOTSCULPTABLE = "Not even science could make that into a sculpture.",
            NOTATRIUMKEY = "I’m not good at shapes.",
        ...
        GIVETOPLAYER =
        {
            FULL = "Hmm, guess it’s mine now!",
            DEAD = "I’ll hang onto this for ya!",
            SLEEPING = "WAKE UP!!",
            BUSY = "I'll try again in a second.",
        },
        GIVEALLTOPLAYER =
        {
            FULL = "Hmm, guess they’re all mine now!",
            DEAD = "I’ll hang onto these for ya!",
            SLEEPING = "WAKE UP!!",
            BUSY = "I'll try again in a second.",
        },
        WRITE =
        ...
        CHANGEIN =
        {
            ...
            BURNING = "Can you say fuego? Muy bien! That’s fire in Spanish.",
        ...
        MOUNT =
        {
            TARGETINCOMBAT = "Dawg looks pretty mad, I should wait.",
            INUSE = "Dawg, hurry up!",
			SLEEPING = "WAKE UP!!",
        },
        SADDLE =
        {
            TARGETINCOMBAT = "Dang dawg, what’re you so mad about?!",
        },
        TEACH =
        {
            --Recipes/Teacher
            KNOWN = "Erm actually, I already know that one.",
        ...
        ROW_FAIL =
        {
            BAD_TIMING0 = "Was I too soon? Fudge!",
            BAD_TIMING1 = "Fudge, my pacing is off.",
            BAD_TIMING2 = "FUDGE!",
        },
        LOWER_SAIL_FAIL =
        {
        ...
        {
            GENERIC = "Erm, not to brag but I have nothing left to learn. ",
        ...
        POUR_WATER =
        {
            OUT_OF_WATER = "Dang, no tengo agua.",
        },
        ...
        USEITEMON =
        {
            --GENERIC = "This won’t work on that, I’ll triple nipple check next time.",
	...
	{
		NO_INGREDIENTS = "Oh shoot, I’m missing some ingredients.",
		NO_TECH = "Erm, guess it’s time to study up.",
		NO_STATION = "Fudge, I can’t make this.",
	},

	ACTIONFAIL_GENERIC = "Bruh, can’t do that.",
	ANNOUNCE_BOAT_LEAK = "Ow, this thing is leaking!",
	ANNOUNCE_BOAT_SINK = "Witches can’t breathe underwater!",
	...
	ANNOUNCE_ADVENTUREFAIL = "Fudge, mou ikkai.",
    ANNOUNCE_MOUNT_LOWHEALTH = "I need a potion to heal it.",
	...
	ANNOUNCE_BEES = "BEEEEEEEEEEEEES, FUUUUUDGE!!!!",
	ANNOUNCE_BOOMERANG = "Fudge! I hope nobody saw that.",
	ANNOUNCE_CHARLIE = "Erm, he’s right behind me, isn’t he?",
	ANNOUNCE_CHARLIE_ATTACK = "OUCH YOU HIT ME!",
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific
	ANNOUNCE_COLD = "Bruh, I’m freezing here!",
	ANNOUNCE_HOT = "Ugh… I’m cooking myself over here.",
	ANNOUNCE_CRAFTING_FAIL = "Mmh… Might need some missing ingredients.",
	ANNOUNCE_DEERCLOPS = "Bruh, i don’t like the sound of that!",
	ANNOUNCE_CAVEIN = "Fudge! This thing is coming down!",
	ANNOUNCE_ANTLION_SINKHOLE =
	{
		"Bruh, what’s with the ground here?!",
		"A tremor?! Oh my days!",
		"What the flip was that about?!",
	},
	ANNOUNCE_ANTLION_TRIBUTE =
	{
        "Fine! Take it I guess!",
        "Meeta’s pop up shop! ",
        "A pleasure doing business with ya! Hehe.",
	},
	ANNOUNCE_SACREDCHEST_YES = "Wow, I LOVE loot!",
	ANNOUNCE_SACREDCHEST_NO = "No bueno.",
    ANNOUNCE_DUSK = "*yawn* It’s getting late. The shop is now closing.",
	...
	{
		GENERIC = "Tasty!",
		PAINFUL = "Ugh, mi pancita.",
		SPOILED = "Bleh! This stuff is nasty!",
		STALE = "Bruh, that stuff was not good.",
		INVALID = "What the? Bruh… I’m not eating that.",
        YUCKY = "Would rather eat a spider than that!",
    ...
    ANNOUNCE_ENCUMBERED =
    {
        "So heavy… Oh… My… DAAAAAAYS",
        "Why didn’t I brew… A potion.. For this",
        "It’s time to… go plus ultra!",
        "Where’s Rito… When you.. Need him..",
        "For... my witch store... wah!",
        "I swear I had… A spell for this",
        "Bruh...!",
        "kjhkljashfkjashflkasjfljkaslfkjasjfkl",
        "I’m a witch… not a weightlifter…",
    },
    ANNOUNCE_ATRIUM_DESTABILIZING =
    {
		"Erm, let’s get out of here!",
		"Ruh roh, Raggy!",
		"It's not safe here.",
	},
    ANNOUNCE_RUINS_RESET = "They’re all back, oh my days!",
    ANNOUNCE_SNARED = "Chicken bone leave me alone!",
    ANNOUNCE_SNARED_IVY = "Tasukete! The garden is fighting back!",
    ANNOUNCE_REPELLED = "Let me hit you!",
	ANNOUNCE_ENTER_DARK = "Erm, I think I’m in a bit of a pickle.",
	ANNOUNCE_ENTER_LIGHT = "MY EYES! Oh, I’m safe now.",
	ANNOUNCE_FREEDOM = "Freedom! But not you Rito!",
	ANNOUNCE_HIGHRESEARCH = "Hehe, I’m the smartest witch!",
	ANNOUNCE_HOUNDS = "Uh, y’all heard that right?",
	ANNOUNCE_WORMS = "Erm, he’s right behind me, isn’t he?",
    ANNOUNCE_ACIDBATS = "Erm, he’s right behind me, isn’t he?",
	ANNOUNCE_HUNGRY = "Tengo hambre!",
	ANNOUNCE_HUNT_BEAST_NEARBY = "\"Sniffing sounds.\" The beast is close!",
	ANNOUNCE_HUNT_LOST_TRAIL = "Fudge, this is why I need Arthur Morgan.",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "This wet soil can't hold a footprint.",
    ANNOUNCE_HUNT_START_FORK = "This trail looks dangerous.",
    ANNOUNCE_HUNT_SUCCESSFUL_FORK = "Oh this was the right way? Hmph not to brag!",
    ANNOUNCE_HUNT_WRONG_FORK = "Stop watching me! I know you’re there ya nasty!",
    ANNOUNCE_HUNT_AVOID_FORK = "This trail looks safer.",
	ANNOUNCE_INV_FULL = "My witch store is full!",
	ANNOUNCE_KNOCKEDOUT = "Ugh, mi cabeza!",
	ANNOUNCE_LOWRESEARCH = "I didn't learn very much from that.",
	ANNOUNCE_MOSQUITOS = "Bruh, not the mosquitos!",
    ANNOUNCE_NOWARDROBEONFIRE = "I can't change while it's on fire!",
    ANNOUNCE_NODANGERGIFT = "Ch-chotto matte! Let me open my gifts!",
    ANNOUNCE_NOMOUNTEDGIFT = "I should get off my beefalo first.",
	ANNOUNCE_NODANGERSLEEP = "My cheeks are clenched!",
	ANNOUNCE_NODAYSLEEP = "IT’S NOT MY BEDTIME!",
	ANNOUNCE_NODAYSLEEP_CAVE = "I'm not tired.",
	ANNOUNCE_NOHUNGERSLEEP = "I can’t sleep when I’m this hungry, maybe I should get some soup.",
	ANNOUNCE_NOSLEEPONFIRE = "Oh my days, it’s on fire! I can’t sleep in that!",
	...
	ANNOUNCE_NO_TRAP = "TOO EASY BABY",
	ANNOUNCE_PECKED = "Ow! Quit it! Stupid bird!",
	ANNOUNCE_QUAKE = "That doesn't sound good.",
	ANNOUNCE_RESEARCH = "Erm, I love learning!",
	ANNOUNCE_SHELTER = "Oshiete, oshiete yo\nSono shikumi wo.",
	ANNOUNCE_THORNS = "Itai!",
	ANNOUNCE_BURNT = "ITAI ITAI! That was hot!",
	ANNOUNCE_TORCH_OUT = "Oh my days! My torch ran out!",
	ANNOUNCE_THURIBLE_OUT = "It's been thuribly depleted.",
	ANNOUNCE_FAN_OUT = "My fan is gone with the wind.",
    ANNOUNCE_COMPASS_OUT = "What the heck? I think the compass broke.",
	ANNOUNCE_TRAP_WENT_OFF = "FUDGE!",
	ANNOUNCE_UNIMPLEMENTED = "OW! I don't think it's ready yet.",
	ANNOUNCE_WORMHOLE = "Am I in the Twilight Zone?",
    ANNOUNCE_WORMHOLE_SAMESPOT = "only_used_by_winona",
	ANNOUNCE_TOWNPORTALTELEPORT = "Was that…\"Magic\"",
	ANNOUNCE_CANFIX = "\nI think I can fix this!",
	ANNOUNCE_ACCOMPLISHMENT = "PERIODT",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "Break it down, break it down aye aye!",
	ANNOUNCE_INSUFFICIENTFERTILIZER = "Are you still hungry, plant?",
	ANNOUNCE_TOOL_SLIP = "Wow, that tool is slippery!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "Heh, I’m just too cool.",
	ANNOUNCE_TOADESCAPING = "Hey, get back here toad!",
	ANNOUNCE_TOADESCAPED = "Don’t run from me you stupid toad!",


	ANNOUNCE_DAMP = "Agua!",
	ANNOUNCE_WET = "Bruh, cut the VOD, I’m all wet now!",
	ANNOUNCE_WETTER = "I should call myself Agüita Osita from now on...",
	ANNOUNCE_SOAKED = "For real dawg, I feel like some sort of sponge!",

	ANNOUNCE_WASHED_ASHORE = "I'm wet, but alive.",

    ANNOUNCE_DESPAWN = "I can see the light!",
	ANNOUNCE_BECOMEGHOST = "ghostghost",
    ...
    ANNOUNCE_ATTACH_BUFF_WORKEFFECTIVENESS = "Erm brain blast!",
    ...
    ANNOUNCE_DETACH_BUFF_SLEEPRESISTANCE   = "It’s not... *yawn* my... bedtime...",

	ANNOUNCE_OCEANFISHING_LINESNAP = "FUDGE! The line snapped.",
	...
	{
		"Hmmm…",
		"Come on out fishies, don’t be shy!",
    ...
    {
        "Erm, I’m kind of a genius when it comes to plants.",
    },
	...
	{
        "Hurry up and grow you stupid plant.",
        "DEKU! YOU’RE GROWING SO NICELY",
		"Hello plant, I'm here for your daily dose of socializing!",
        "What a nice plant you are Deku.",
        "DEKU, YOU’RE SUCH A GOOD LISTENER, SUCH A GOOD TOMODACHI",
	},
	...
	{
		GENERIC = "SCREEEE!",
		PIG = "Come here cerdito!",
		PREY = "RAAAAWR!",
		SPIDER = "Yo a spider! I’ll eat it.",
		SPIDER_WARRIOR = "Yooo! We about to scrap for real dawg!",
		DEER = "I’M GONNA KILL YOU!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "Fudge! Well then, that’s okay.",
		PIG = "BIBIDI BOPIDI BOO STOOPID!",
		PREY = "Arf arf arf! Grrrr.",
		SPIDER = "Hmph! Too easy for me anyways.",
		SPIDER_WARRIOR = "Go back to your mama!",
	},

	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "What the freak! What kind of magic is this?",
        MULTIPLAYER_PORTAL_MOONROCK = "Erm, by my calculations, this is magic to isekai us.",
        MOONROCKIDOL = "Could I use this to spawn my husbands?",
        CONSTRUCTION_PLANS = "Scrolls for magic!",
		...
		BOOKSTATION =
		{
			GENERIC = "I LOVE manga!",
			BURNT = "Was Cyon here?",
		},
        BOOK_BIRDS = "Bet Rito would love this book.",
        BOOK_TENTACLES = "R'lyeh wgah'nagl fhtagn!",
        BOOK_GARDENING = "HEY! How the freak did you get this book!?",
		BOOK_SILVICULTURE = "AH! I can’t read!",
		BOOK_HORTICULTURE = "Bruh, that wasn’t abridged at all!",
        BOOK_SLEEP = "A nice book, some hot soup and a mimir!",
        BOOK_BRIMSTONE = "Bruh, ain’t no way!",

        BOOK_FISH = "It didn't really hook me.",
        BOOK_FIRE = "Bet Cyon would love this book.",
        BOOK_WEB = "New spider recipes, yum!",
        BOOK_TEMPERATURE = "My thoughts on it are only lukewarm.",
        BOOK_LIGHT = "Y se hizo la luz!",
        BOOK_RAIN = "Oshiete, oshiete yo\nSono shikumi wo.",
        BOOK_MOON = "All this interest in the moon is probably just a phase.",
        BOOK_BEES = "This is the bees knees.",
        
        BOOK_HORTICULTURE_UPGRADED = "It's about as exciting as watching grass grow.",
        BOOK_RESEARCH_STATION = "A manga a day keeps my sanity at bay!",
        BOOK_LIGHT_UPGRADED = "Brillante!",

        FIREPEN = "Strike while the pen's hot!",

        PLAYER =
        {
            GENERIC = "Hola %s, besitos MWAH!",
            ATTACKER = "Ouch! %s hit me!",
            MURDERER = "%s is the murderer!",
            REVIVER = "%s, you can cast revive magic?!",
            GHOST = "%s looks like they need their soul captured.",
            FIRESTARTER = "You didn’t have to do that, %s!",
        },
        WILSON =
        {
        ...
        MIGRATION_PORTAL =
        {
        --    GENERIC = "So this can take me to the girlies? First stop Raccoon world!",
		...
		MOLE =
		{
			...
			UNDERGROUND = "Algo esta aqui.",
			ABOVEGROUND = "I’m V&U’s one and only whack a mole champion!",
		},
		MOLEHILL = "Hehe, what if I cover the hole.",
		MOLEHAT = "A wretched stench, but excellent visibility.",

		EEL = "I love seahorses! Oh wait, that’s an eel.",
        ...
        MOONBASE =
        {
            ...
            STAFFED = "Now what?",
            WRONGSTAFF = "I should triple nipple check to make sure this is the right one.",
		...
		GREENGEM = "A gem for construction magic!",
		...
		YELLOWGEM = "A gem for light magic!",
		ORANGEGEM = "A gem for lazy magic!",
        OPALSTAFF = "It's scientifically proven that gems look better on top of sticks.",
        OPALPRECIOUSGEM = "A very special gem!",
        TELEBASE =
		{
		...
		COMPASS =
		{
			GENERIC="I’m not good at directions.",
			N = "North.",
			S = "South.",
			E = "East.",
			W = "West.",
        ...
        BAT = "Ew! You look uglier than Rito!",
        ...
        GUANO = "Yo this is advanced doo-doo.",
        ...
        SLURTLE = "Ew! That’s you Customers!",
        ...
        CAVE_ENTRANCE = "Hmm, looks like there’s something underneath.",
		...
		AMULET = "A magic amulet to give me Second Wind!",
		ANIMAL_TRACK = "I need a man like Arthur Morgan to track the animal.",
		ARMORGRASS = "I’m just a small girl in the countryside!",
		...
		ASH =
		{
			GENERIC = "Baka Tanuki probably did this.",
		...
		AXE = "An axe for my future lumberjack husband!",
		BABYBEEFALO =
		{
		...
		BEARDHAIR = "Shame, I prefer my men with beards.",
		...
		BEDROLL_STRAW = "Aw heck no dawg, this is going to be a rough night.",
		...
		BEEFALO =
		{
			...
			GENERIC = "Is that a giant buffalo?!",
			NAKED = "Aww, he's so sad.",
			SLEEPING = "It’s sleeping… time to murder!",
            --Domesticated states:
        ...
        BERRIES_JUICY = "Yatta! Super juicy berries! Pero, I gotta eat them quick.",
        BERRIES_JUICY_COOKED = "I gotta eat them before they spoil.",
		BERRYBUSH =
		{
			BARREN = "I think it needs to be fertilized.",
			WITHERED = "Nothing will grow in this heat.",
			GENERIC = "Wow, I love berries!",
			PICKED = "Berries doko?",
		...
		BIRDCAGE =
		{
			GENERIC = "I wonder if Rito would fit in here... Stupid bird...",
			OCCUPIED = "You’re not Rito, but you’ll do.",
			SLEEPING = "Awwww, he's sleeping… WAKE UP!!",
		...
		BLUEGEM = "A gem for ice magic!",
		BLUEPRINT =
		{
            COMMON = "It's scientific!",
            RARE = "It's REALLY scientific!",
        },
        SKETCH = "I know just the place to make this, but only for a price, hehe.",
		COOKINGRECIPECARD =
		{
			GENERIC = "Science help me, I can't decipher this handwriting.",
		},
		BLUE_CAP = "I love mushrooms!",
		BLUE_CAP_COOKED = "It's different now...",
		BLUE_MUSHROOM =
		{
			GENERIC = "I love mushrooms!",
			INGROUND = "Come on! I need you for my potions.",
			PICKED = "Mushroom doko?",
		},
		BOARDS = "Boards.",
		BONESHARD = "bonebone",
		BONESTEW = "A stew to put some meat on your bones.",
		BUGNET = "For jellyfishing!",
		BUSHHAT = "What the heck is this hat.",
		BUTTER = "My stomach won’t survive this.",
		BUTTERFLY =
		{
			GENERIC = "Hapi hapi hapi butterfly!",
			HELD = "Now I have you!",
		},
		...
		CACTUS =
		{
			GENERIC = "Watch me pick this cactus without hurting myself.",
			PICKED = "Cactus doko.",
		},
		...
		COLDFIRE =
		{
			EMBERS = "Might need to use Cyon’s hat if we can’t find more fuel.",
			GENERIC = "Let’s tell spooky stories!",
			HIGH = "Itai! Better not get too close!",
			LOW = "Aww man, it’s running out.",
			NORMAL = "Let’s gather around the campfire\nAnd sing our campfire song!\nOur C-A-M-P-F-I-R-E S-O-N-G song!",
			OUT = "Owari da…",
		},
		CAMPFIRE =
		{
		...
		CARROT = "Yuck! Vegetables!",
		CARROT_COOKED = "Eww. It’s all mushy and yucky now!",
		CARROT_PLANTED = "Zanahoria.",
		CARROT_SEEDS = "It's a seed.",
		CARTOGRAPHYDESK =
		{
			GENERIC = "Now I can find my husbands!",
			BURNING = "Can you say fuego? Muy bien! That’s fire in Spanish.",
			BURNT = "Eotteoke, eotteoke~!",
		},
		WATERMELON_SEEDS = "It's a seed.",
		CAVE_FERN = "It's a fern.",
		CHARCOAL = "Yatta! More fuel!",
		...
		CHESTER_EYEBONE =
		{
			GENERIC = "Yo that’s freaky. It’s looking at me.",
			WAITING = "Buenas noches.",
		},
		COOKEDMANDRAKE = "Poor little guy.",
		COOKEDMEAT = "Carne asada! Yum, yum, yum!",
		COOKEDMONSTERMEAT = "Eww... That’s nasty dawg!",
		COOKEDSMALLMEAT = "Carne asada! Yum, yum, yum!",
		COOKPOT =
		{
			...
			BURNT = "We shouldn’t have let them cook...",
		},
		CORN = "Me gusta maiz!",
		CORN_COOKED = "Me gusta maiz!",
		...
		CUTGRASS = "I make potions, but I can do arts and crafts too!",
		CUTREEDS = "I make potions, but I can do arts and crafts too!",
		CUTSTONE = "It’s so smooth!",
		...
		LAVA_POND = "God dang, I should be careful around that.",
		...
		DUG_SAPLING = "Sebastian, wait for me!",
		DURIAN = "Oh, it smells!",
		...
		DECIDUOUSTREE =
		{
			BURNING = "Can you say fuego? Muy bien! That’s fire in Spanish.",
			BURNT = "Eotteoke, eotteoke~!",
			CHOPPED = "It’s all for Sebastian, my emo husband!",
			POISON = "It looks unhappy about me stealing those birchnuts!",
			GENERIC = "Why I ought cut you down!",
		},
		ACORN = "I gotta plant this to get more wood for Sebastian!",
        ACORN_SAPLING = "Sebastian, wait for me!",
		...
		EVERGREEN_SPARSE =
		{
			...
			BURNT = "Eotteoke, eotteoke~!",
			CHOPPED = "It’s all for Sebastian, my emo husband!",
			GENERIC = "A sad looking Christmas tree.",
		},
		TWIGGYTREE =
		{
			BURNING = "Can you say fuego? Muy bien! That’s fire in Spanish.",
			BURNT = "Eotteoke, eotteoke~!",
			CHOPPED = "It’s all for Sebastian, my emo husband!",
			GENERIC = "I bet I can knock this down! I know muay thai afterall!",
			DISEASED = "It looks sick. More so than usual.", --unimplemented
		},
		TWIGGY_NUT_SAPLING = "Sebastian, wait for me!",
        TWIGGY_OLD = "That tree looks pretty wimpy.",
		TWIGGY_NUT = "I gotta plant this to get more wood for Sebastian!",
		...
		FIREFLIES =
		{
			GENERIC = "Hmm, these could be added to my next potion and sold at an \"affordable\" price!",
		...
		FIREPIT =
		{
			...
			LOW = "Aww man, it’s running out.",
			NORMAL = "Let’s gather around the campfire\nAnd sing our campfire song!\nOur C-A-M-P-F-I-R-E S-O-N-G song!",
			OUT = "Owari… ja nai! It can start up again.",
		},
		COLDFIREPIT =
		{
			EMBERS = "Might need to use Cyon’s hat if we can’t find more fuel.",
		...
		FIRESTAFF = "Oh my, this could be fun! MUAHAHA!",
		FIRESUPPRESSOR =
		{
			ON = "Fling on!",
		...
		FLOWER =
		{
            GENERIC = "Thank you for the flowers! *sniff*",
            ROSE = "Thank you for the roses! *sniff*",
        },
		...
		FROG =
		{
			DEAD = "Time to brew some potions.",
			GENERIC = "A witch’s favorite recipe.",
			SLEEPING = "Aww, look at him sleep… time to slaughter~!",
		},
		FROGGLEBUNWICH = "A very leggy sandwich.",
		FROGLEGS = "Frog-leg candy that stops crying babies in their tracks!",
		FROGLEGS_COOKED = "Tastes like chicken.",
		FRUITMEDLEY = "Fruity.",
		FURTUFT = "Black and white fur.",
		GEARS = "A pile of mechanical parts.",
		GHOST = "Tia, I didn’t expect to see you here.",
		...
		HONEYCOMB = "I can use this for my potions.",
		...
		HOUND = "Dawg doesn’t have that dog in em.",
		HOUNDCORPSE =
		{
		...
		KILLERBEE =
		{
			GENERIC = "FUDGE! It’s even worse than normal bees!",
		...
		GOATMILK = "Hmm, maybe we should Bag this Milk?",
		LITTLE_WALRUS = "He won't be cute and cuddly forever.",
		LIVINGLOG = "Dawg, you good in there?",
		LOG =
		{
			BURNING = "Can you say fuego? Muy bien! That’s fire in Spanish.",
			GENERIC = "Sebastian, I’m going to marry you!",
		},
        ...
        MARBLE = "I'm losing my marbles, what is this stuff!?",
        MARBLEBEAN = "I traded the old family cow for it.",
        MARBLEBEAN_SAPLING = "Sebastian, wait for me!",
        ...
        MARSH_BUSH =
        {
			BURNT = "Eotteoke, eotteoke~!",
            BURNING = "Can you say fuego? Muy bien! That’s fire in Spanish.",
            GENERIC = "It’s going to hurt for sure.",
            PICKED = "Itai!",
        },
        BURNT_MARSH_BUSH = "Eotteoke, eotteoke~!",
        ...
        MERMHEAD =
        {
            GENERIC = "Ew, you need to take a shower dawg!",
            BURNT = "Eotteoke, eotteoke~!",
        },
        MERMHOUSE =
        {
            GENERIC = "Now, where’s the invisible boatmobile?",
            BURNT = "Who burnt it down? Was it Man Ray or the Dirty Bubble?!",
        },
        MINERHAT = "A hands-free way to brighten your day.",
        MONKEY = "Curious little guy.",
        MONKEYBARREL = "Did that just move?",
        MONSTERLASAGNA = "Maybe I’m more picky than I thought..",
        FLOWERSALAD = "A bowl of foliage.",
        ICECREAM = "Yum, ice cream so good.",
        WATERMELONICLE = "Cryogenic watermelon.",
        TRAILMIX = "A healthy, natural snack.",
        HOTCHILI = "It’s spicy, but I like it!",
        GUACAMOLE = "Avogadro's favorite dish.",
        MONSTERMEAT = "It should be fine… verda?",
        MONSTERMEAT_DRIED = "Strange-smelling jerky.",
        MOOSE = "WHAT IS THAT HORRIBLE CREATURE?!",
        MOOSE_NESTING_GROUND = "It puts its babies there.",
        MOOSEEGG = "NOOOO! It’s going to hatch more of those things!",
        MOSSLING = "Hello little one, do you know the story of Bambi?",
        FEATHERFAN = "I could make a fortune off of these at the witch store.",
        MINIFAN = "This whirly fan will protect you from overheating. Buy now only for 20 diamonds!",
        GOOSE_FEATHER = "It’s so soft!",
        STAFF_TORNADO = "Spinning doom.",
        MOSQUITO =
        {
            GENERIC = "I HATE mosquitos!",
            HELD = "Hey, is that my blood?",
        },
        MOSQUITOSACK = "It's probably someone else's blood...",
        MOUND =
        {
            DUG = "I love grave robbing!",
            GENERIC = "Finder’s keeper! Hehe.",
        },
        NIGHTLIGHT = "The light coming off of this is kind of unsettling.",
        NIGHTMAREFUEL = "This stuff is crazy!",
        NIGHTSWORD = "Why would anyone make this? It's terrifying.",
        NITRE = "I'm a witch, not a geologist or whateva.",
        ...
        PERD = "Get away from those berries! Dang bird!",
        PEROGIES = "These turned out pretty good.",
        PETALS = "I sniffed the flower too strongly…",
        PETALS_EVIL = "I'm not sure I want to hold those.",
        PHLEGM = "It's thick and pliable. And salty.",
        PICKAXE = "Got our pickaxe swinging from side to side.",
        PIGGYBACK = "This little piggy's gone... \"home\".",
        PIGHEAD =
        {
            GENERIC = "Bye bye customers!",
            BURNT = "Eotteoke, eotteoke~!",
        },
        PIGHOUSE =
        {
            FULL = "Yo momma and your momma’s momma.",
            GENERIC = "Crusty, rusty, dusty, musty, yucky house.",
            LIGHTSOUT = "Abre por favor!",
            BURNT = "Eotteoke, eotteoke~!",
        },
        PIGKING = "Ewww, that’s you Customer is Kings!",
        PIGMAN =
        {
            DEAD = "To the shadow realm!",
            FOLLOWER = "Follow me dear customer!",
            GENERIC = "Eww, that’s you chat.",
            GUARD = "Looks serious.",
            WEREPIG = "Ewww, that’s you Customers!",
        },
        PIGSKIN = "It still has the tail on it.",
        PIGTENT = "Smells like bacon.",
        PIGTORCH = "Sure looks cozy.",
        PINECONE = "I gotta plant this to get more wood for Sebastian!",
        PINECONE_SAPLING = "Sebastian, wait for me!",
        LUMPY_SAPLING = "Sebastian, wait for me!",
        ...
        POND = "Agua!",
        POOP = "That’s doo-doo dawg.",
        FERTILIZER = "That is definitely a bucket full of poop.",
        PUMPKIN = "Mmh, me gusta pastel de calabaza!",
        PUMPKINCOOKIE = "Me gusta galleta de calabaza!",
        PUMPKIN_COOKED = "Where’s my pastel de calabaza?",
        PUMPKIN_LANTERN = "Spooky!",
        PUMPKIN_SEEDS = "It's a seed.",
        PURPLEAMULET = "It's whispering to me.",
        PURPLEGEM = "A gem for dark magic!",
        RABBIT =
        {
            GENERIC = "...Cerenity?!",
        ...
        RABBITHOLE =
        {
            GENERIC = "Come out so I can kill you!",
        ...
        RATATOUILLE = "Just as good as Remy & Alfredo would make.",
        RAZOR = "But I want my man to have a beard!",
        REDGEM = "A gem for fire magic!",
        RED_CAP = "I love mushrooms!",
        ...
        RESEARCHLAB =
        {
            GENERIC = "Science? This seems more like \"Magic!\"",
            BURNT = "It disappeared like magic too...",
        },
        RESEARCHLAB2 =
        {
        ...
        RESURRECTIONSTONE = "SECONDO WINDO!",
        ROBIN =
        {
            GENERIC = "Stupid bird!",
        ...
        ROCK_ICE =
        {
            GENERIC = "I could make ice cream with this! But my stomach…",
            MELTED = "Can’t I just freeze this with a spell!",
        },
        ROCK_ICE_MELTED = "Can’t I just freeze this with a spell!",
        ICE = "Ice to meet you.",
        ROCKS = "I rock? NO, YOU ROCK!",
        ROOK = "Storm the castle!",
        ROPE = "I can double dutch. I’m the jump rope queen afterall. ",
		...
		SAPLING =
		{
			...
			GENERIC = "Watch me snap it in half! Hehe.",
			PICKED = "Five, six, pick up sticks!",
			DISEASED = "It looks pretty sick.", --removed
			DISEASING = "Err, something's not right.", --removed
		},
   		SCARECROW =
   		{
			GENERIC = "This should keep all those stupid birds away!",
			BURNING = "Can you say fuego? Muy bien! That’s fire in Spanish.",
			BURNT = "Eotteoke, eotteoke~!",
   		},
   		SCULPTINGTABLE=
   		{
			EMPTY = "We can make anime figures with this!",
			BLOCK = "Ready for sculpting.",
			SCULPTURE = "A masterpiece!",
			BURNT = "Eotteoke, eotteoke~!",
   		},
        SCULPTURE_KNIGHTHEAD = "It’s missing its body… the loot is mine!",
		SCULPTURE_KNIGHTBODY =
		{
			COVERED = "Nani kore? A marble statue?",
			UNCOVERED = "Eh? What happened? WAKANAI!",
        ...
        GARGOYLE_HOUND = "Does this thing perceive me..?",
        GARGOYLE_WEREPIG = "Why does it feel like it perceives me?",
		SEEDS = "I guess I can use this to feed Rito. Hmph!",
		SEEDS_COOKED = "Bada bing bada boom! 5 star meal right here.",
		SEWING_KIT = "Darn it! Darn it all to heck!",
		SEWING_TAPE = "Good for mending.",
		SHOVEL = "It’s a magic spoon! Only for 5 diamonds!",
		SILK = "BAKUDEKU SLIME BAKUDEKU SLIME!",
		SKELETON = "Chat, don’t hate the player, hate the game baby.",
		SCORCHED_SKELETON = "Spooky.",
        SKELETON_NOTPLAYER = "These are not human bones.",
		SKULLCHEST = "I'm not sure if I want to open it.", --removed
		SMALLBIRD =
		{
			GENERIC = "What a stupid bird.",
			HUNGRY = "The dumb bird is hungry!",
			STARVING = "It must be starving.",
			SLEEPING = "It’d be a real shame if someone woke it up.",
		},
		SMALLMEAT = "I gotta grill this!",
		SMALLMEAT_DRIED = "A little jerky.",
		SPAT = "Ew! That’s you Customers!",
		SPEAR = "Now, who to poke first. Oh Rito~!",
		SPEAR_WATHGRITHR = "It feels very stabby.",
		WATHGRITHRHAT = "Pretty fancy hat, that.",
		SPIDER =
		{
			DEAD = "It went splat!",
			GENERIC = "Have you ever eaten a spider? I have.",
			SLEEPING = "Yummy spider!",
		},
		SPIDERDEN = "Sticky! Maybe I can make BAKUDEKU slime!",
		SPIDEREGGSACK = "I hope these don't hatch. Period.",
		SPIDERGLAND = "Eww, this heals me?",
		...
		SPOILED_FOOD = "Ewww, naur way! It’s all hairy.",
        STAGEHAND =
        {
			AWAKE = "AHH! Six feet! Six feet!",
			HIDING = "Nani kore. Something is under there.",
        },
        STATUE_MARBLE =
        {
		...
		STINGER = "Ugh, I hate needles.",
		STRAWHAT = "I’m just a small girl in the countryside!",
		...
		TALLBIRD = "That's a stupidly tall bird!",
		...
		TENTACLE = "A new ingredient for my potions!",
		...
		TORCH = "I hope this isn’t used on witches like me.",
		TRANSISTOR = "It's whirring with electricity.",
		TRAP = "You’ll be trapped in my witch store soon, hehe.",
		...
		TRINKET_1 = "I held my dad’s balls.", --Melted Marbles
		TRINKET_2 = "What's kazoo with you?", --Fake Kazoo
		TRINKET_3 = "The knot is stuck. Forever.", --Gord's Knot
		TRINKET_4 = "Hey Cyon, want to do the gnome challenge again?", --Gnome
		TRINKET_5 = "A Toy rocket ship!", --Toy Rocketship
		TRINKET_6 = "Hmm, I’ll just sell it as new!", --Frazzled Wires
		TRINKET_7 = "The Osita family have been ballers for life.", --Ball and Cup
		TRINKET_8 = "Great. All of my tub stopping needs are met.", --Rubber Bung
		TRINKET_9 = "I guess I could use this to repair my customers. Hmph!", --Mismatched Buttons
		TRINKET_10 = "Liora, I found your dentures!", --Dentures
		TRINKET_11 = "Aww, you’re just like my Vtuber wife Echo!", --Lying Robot
		TRINKET_12 = "I found tentacles for my next potions!", --Dessicated Tentacle
		TRINKET_13 = "Hey Cyon, want to do the gnome challenge again?", --Gnomette
		TRINKET_14 = "I should give this to Tia!", --Leaky Teacup
		...
		TRINKET_18 = "A Toy horse!", --Trojan Horse
		TRINKET_19 = "Fudge, it’s crooked.", --Unbalanced Top
		TRINKET_20 = "Wigfrid keeps jumping out and hitting me with it?!", --Backscratcher
		TRINKET_21 = "I hope I can reach quota with this.", --Egg Beater
		TRINKET_22 = "Huh. I could give this to my cats.", --Frayed Yarn
		TRINKET_23 = "The freak! Why would I use this!", --Shoehorn
		TRINKET_24 = "It’s nothing like my cats.", --Lucky Cat Jar
		TRINKET_25 = "I could use this for my ca- I MEAN BROOM!", --Air Unfreshener
		TRINKET_26 = "It’s food and a cup for my agua! Yatta!", --Potato Cup
		...
		LIVINGTREE_SAPLING = "Sebastian, wait for me!",
        ...
        WARGSHRINE =
        {
            ...
            BURNING = "Can you say fuego? Muy bien! That’s fire in Spanish.", --for willow to override
		...
		TUMBLEWEED = "A cowboy must be near.",
		TURKEYDINNER = "Mmmm.",
		TWIGS = "What in the butt is with all these twigs?!",
		UMBRELLA = "I always hate when my hair gets wet and poofy.",
		GRASS_UMBRELLA = "Echo~! Do you want to share this parasol with me~!",
		...
		WORMHOLE =
		{
			GENERIC = "Erm, what the scallop.",
			OPEN = "Maybe I’ll find my husband in here.",
		},
		...
		HUMANMEAT = "Who knew humans were so stringy?",
		HUMANMEAT_COOKED = "Sorry Maeve... Hmm, tastes like chicken.",
		HUMANMEAT_DRIED = "Letting it dry makes it not come from a human, right?",
		ROCK_MOON = "Is that a freaking rock from the moon?!",
		MOONROCKNUGGET = "Take her to the moon for me.",
		...
		BOOK_ELEMENTAL = "AH! I can’t read!",
        ...
        --food--
        QUAGMIRE_FOOD_BURNT = "Eotteoke, eotteoke~!",
        QUAGMIRE_FOOD =
        {
        ...
        QUAGMIRE_SAPLING = "Sebastian, wait for me!",
        ...
        MINIFLARE = "I can light it to let everyone know I'm here, not that I need help or anything.",
        ...
        BOAT_GRASS_ITEM = "Let’s go sailing for treasures!",
        ...
        WALKINGPLANK = "Walk the plank! Hehe, I love pirates!",
        WALKINGPLANK_GRASS = "Walk the plank! Hehe, I love pirates!",
        OAR = "Customer! Get rowing! Chop chop!",
		OAR_DRIFTWOOD = "Customer! Get rowing! Chop chop!",

		OCEANFISHINGROD = "Now I can fish flounders for my husband Sebastian!",
		OCEANFISHINGBOBBER_NONE = "A bobber might improve its accuracy.",
        OCEANFISHINGBOBBER_BALL = "Fish? Bawling. Me? Ballin’. Hehe.",
		...
		SPOILED_FISH = "Ew, that smells disgusting!",
        ...
        SPICE_CHILI = "It’s spicy, but I like it.",
        ...
        DRAGONCHILISALAD = "It’s spicy, but I like it!",
        ...
        SALSA = "This is spicy, but I like it!",
		...
		MESSAGEBOTTLE = "My pirate husband left me a message!",
		MESSAGEBOTTLEEMPTY = "Dang it, it’s empty.",
        ...
        WALL_STONE_2 = "Yup, that’s a wall.",
        ...
        BIRD_MUTANT = "Stupid bird!",
        BIRD_MUTANT_SPITTER = "Stupid bird!",
        ...
        OCEANTREENUT = "I gotta plant this to get more wood for Sebastian!",
        ...
        PALMCONE_SAPLING = "Sebastian, wait for me!",
        ...
        CHARLIE_STAGE_POST = "BOOGIE WOOGIE ENVIRONMENT!",
        ...
        STATUEHARP_HEDGESPAWNER = "Dawg wears flowers.",
        HEDGEHOUND = "What the freak!",
        HEDGEHOUND_BUSH = "Hmm, that bush looks off.",
        ...
        STAGEUSHER =
        {
            STANDING = "Six feet six feet!",
            SITTING = "Dawg, are you hiding in there?",
        },
        SEWING_MANNEQUIN =
        {
            GENERIC = "Wow, you’re so cool!",
            BURNT = "Eotteoke, eotteoke~!",
        },
        ...
        SCRAPBOOK_PAGE = "Ooh, I found someone else’s fanfic. Hehe.",
        ...
        DEERCLOPSCORPSE =
        {
            GENERIC  = "Heh, first try. Too easy!",
            BURNING  = "Can you say fuego? Muy bien! That’s fire in Spanish.",
        ...
        FENCE_JUNK = "A fence won’t stop me from finding treasure!",
        JUNK_PILE = "Another one’s junk is another witch’s treasure!",
        JUNK_PILE_BIG = "I hit the jackpot baby!",
    ...
    DESCRIBE_TOODARK = "WAH! I can’t see anything!",
