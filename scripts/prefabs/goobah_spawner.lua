...
local function ondeploy(inst, pt)
    ...
    local tree = SpawnPrefab("goobah_portal")
    if tree ~= nil then
...
local function fn()
    ...
    inst.components.inventoryitem.imagename = "goobah_spawner"
    inst.components.inventoryitem.atlasname = "images/goobah_spawner.xml"
...
return Prefab("goobah_spawner", fn, assets, prefabs),
