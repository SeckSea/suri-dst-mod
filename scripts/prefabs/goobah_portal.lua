    ...
    if not inst.components.health:IsDead() then
        ...
        if inst.components.childspawner ~= nil then
            ...
            for k = 1, num_to_release do
                inst.components.childspawner.childname = "goobah"
...
return Prefab("goobah_portal", MakeSpiderDenFn(1), assets, prefabs),
    Prefab("goobah_portal_2", MakeSpiderDenFn(2), assets, prefabs),
       Prefab("goobah_portal_3", MakeSpiderDenFn(3), assets, prefabs)