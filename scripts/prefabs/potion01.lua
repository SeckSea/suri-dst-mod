local assets =
{
	Asset("ANIM", "anim/meetapotions.zip"),
...
local function fn()
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/potion01.xml"
...
return Prefab("common/inventory/potion01", fn, assets, prefabs),
